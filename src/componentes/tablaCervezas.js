...
export const tablaCervezas = {
    template: `
    <h2>Esto es lo que te has tomado ya...</h2>
    <table class="table">
    <thead>
        <tr>
    ...
    script: () => {
        ...
        main.addEventListener("click", (event) => {
            if (event.target.classList.contains('enviarPedido')) {
                ...
                if (formPedido.checkValidity()) {
                    ...
                    tr.innerHTML = `
                        ...
                        <td class="px-5"><button type="button" class="btn btn-warning editar" id="editarPedido">Editar Pedido</button></td>
                    </tr>
                    `
            ...
            if (event.target.classList.contains('eliminar')) {
                ...
                const posicion = pedido.findIndex(pedido=>pedido.id == cervezaID)

                console.log(posicion)

                pedido.splice(posicion,1)
